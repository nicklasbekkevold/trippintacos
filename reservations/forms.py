...
from reservations.models import NewReservation, Reservation, Restaurant, Table, Guest
...
class DynamicReservationForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ('guest', 'number_of_people', 'start_date', 'start_time', 'end_time', 'reminder')
